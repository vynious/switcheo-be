...
var (
	...
	fd_User_username protoreflect.FieldDescriptor
	fd_User_password protoreflect.FieldDescriptor
...
func init() {
	...
	fd_User_username = md_User.Fields().ByName("username")
	fd_User_password = md_User.Fields().ByName("password")
...
func (x *fastReflection_User) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Username != "" {
		...
		if !f(fd_User_username, value) {
			return
		}
	}
	if x.Password != "" {
		value := protoreflect.ValueOfString(x.Password)
		if !f(fd_User_password, value) {
			return
		}
	}
	if x.Address != "" {
...
func (x *fastReflection_User) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "crude.crude.User.email":
		return x.Email != ""
	case "crude.crude.User.username":
		return x.Username != ""
	case "crude.crude.User.password":
		return x.Password != ""
...
func (x *fastReflection_User) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "crude.crude.User.username":
		panic(fmt.Errorf("field username of message crude.crude.User is not mutable"))
	case "crude.crude.User.password":
		panic(fmt.Errorf("field password of message crude.crude.User is not mutable"))
	case "crude.crude.User.address":
...
var file_crude_crude_user_proto_rawDesc = []byte{
	...
	0x63, 0x72, 0x75, 0x64, 0x65, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72,
	...
	0x65, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x67, 0x65, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x61, 0x67, 0x65, 0x42, 0x87, 0x01, 0x0a, 0x0f, 0x63, 0x6f, 0x6d, 0x2e,
	0x63, 0x72, 0x75, 0x64, 0x65, 0x2e, 0x63, 0x72, 0x75, 0x64, 0x65, 0x42, 0x09, 0x55, 0x73, 0x65,
	0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x1c, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	0x73, 0x64, 0x6b, 0x2e, 0x69, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x72, 0x75, 0x64, 0x65,

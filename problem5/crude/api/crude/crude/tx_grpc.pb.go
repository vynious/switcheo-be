...
const (
	...
	Msg_CreateUser_FullMethodName         = "/crude.crude.Msg/CreateUser"
	Msg_UpdateUser_FullMethodName         = "/crude.crude.Msg/UpdateUser"
	Msg_UpdateUserPassword_FullMethodName = "/crude.crude.Msg/UpdateUserPassword"
	Msg_DeleteUser_FullMethodName         = "/crude.crude.Msg/DeleteUser"
)
...
func (c *msgClient) UpdateUserPassword(ctx context.Context, in *MsgUpdateUserPassword, opts ...grpc.CallOption) (*MsgUpdateUserPasswordResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_UpdateUserPassword_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) UpdateUserPassword(context.Context, *MsgUpdateUserPassword) (*MsgUpdateUserPasswordResponse, error) {
...
func _Msg_UpdateUserPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_UpdateUserPassword_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
